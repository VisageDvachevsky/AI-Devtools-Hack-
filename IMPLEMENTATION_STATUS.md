...
1. Улучшить GitHub skill scoring (см. MCP_INTEGRATION.md)
2. Добавить реальную LinkedIn интеграцию
3. Реализовать LLM-based resume parsing
4. Добавить batch processing для множества кандидатов
5. Расширить market analytics (trends, forecasting)
6. Добавить A/B тестирование скоринг моделей